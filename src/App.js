      ...
      <BrowserRouter>
        <div className="container">
          ...
          <nav className="main-nav">
            <ul>
              <li>
                <NavLink onClick={this.onNavClick} exact to="/">
                  Home
                </NavLink>
              </li>
              <li>
                <NavLink onClick={this.onNavClick} to="/cats">
                  Cats
                </NavLink>
              </li>
              <li>
                <NavLink onClick={this.onNavClick} to="/dogs">
                  Dogs
                </NavLink>
              </li>
              <li>
                <NavLink onClick={this.onNavClick} to="/owls">
                  Owls
                </NavLink>
              </li>
            </ul>
